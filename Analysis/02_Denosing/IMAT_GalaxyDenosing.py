...
def process_cr_dataset(participant_range=None, participant_list=None):
...
if __name__ == "__main__":
    process_cr_dataset(participant_range=(22, 24))
    #
    # participant_list = ["P03"]
    # process_cr_dataset(participant_list=participant_list)
